...
NL_map <- leaflet(width = 1900, height = 2250) |> 
      ...
      addPolygons(data = watersheds, color = ~pal(color_id), weight = 1.5, fillColor = ~pal(color_id), fillOpacity = 0.3, options = pathOptions(pane = "drainage"), popup = ~label_text)  |>
