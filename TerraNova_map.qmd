...
TN_map <- leaflet(width = "100vw", height = "75vh", options = leafletOptions(zoomSnap = 0.25)) |> 
      ...
      addPolygons(data = TN_drainage, color = "#236D9E", weight = 1.5, fillColor = "#236D9E", fillOpacity = 0.2, options = pathOptions(pane = "drainage")) |>
  
      ## rivers of the rocky
      addPolylines(data = TN_river, color = "#236D9E", weight = 3/TN_river$ORD_CLAS, options = pathOptions(pane = "river"), group = "TN", opacity = 0.8) |>

      ### D50
      addPolylines(data = TN_river, color = D50.col, weight = 3/TN_river$ORD_CLAS, opacity = 1, options = pathOptions(pane = "data_D50"), group = "D50", popup = ~label_text) |>
      ...
      ### discharge
      addPolylines(data = TN_river, color = ~discharge.pal(TN_river$DIS_AV_CMS), weight = 3/TN_river$ORD_CLAS, opacity = 1, options = pathOptions(pane = "data_disch"), group = "Discharge", popup = ~label_text) |>
      ...
      ### width
      addPolylines(data = TN_river, color = ~width.pal(TN_river$width), weight = 3/TN_river$ORD_CLAS, opacity = 1, options = pathOptions(pane = "data_width"), group = "Width", popup = ~label_text) |>
      ...
      ### gradient
      addPolylines(data = TN_river, color = ~gradient.pal(TN_river$sgr_dk_rav/10000), weight = 3/TN_river$ORD_CLAS, opacity = 1, options = pathOptions(pane = "data_grad"), group = "Gradient", popup = ~label_text) |>
      ...
      addPolygons(data = TN_lakes, color = "#236D9E", stroke = FALSE, fillOpacity = 0.7, options = pathOptions(pane = "lakes"), group = "TN") |>
...
[Download the Terra Nova River HydroATLAS data shapefile](https://github.com/emmwilson/NL_watersheds/blob/0d9a7a8e31f9d6fc5a61aac211dbf85ce949138c/data/spatial%20data/Terranova_rivers.shp?raw=true)
