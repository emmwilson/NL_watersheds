...
:::{.nonincremental}
1) In GitHub copy the url to the repository
:::
...
![](data/for%20webpage/new_project.png){width="30%"}
:::

::: {.fragment .nostretch .nonincremental}
i) Select Version control, using GIT 
...
iii) Give the repository a folder name on your computer,</br> and choose where to store it
:::
...
There are also other files that are important to building a quorto webpage:
...
::: {.nonincremental}
Add in name of variable, range, starting value, step, and label
...
based on data from sampled reaches
...
Add palettes as you add response variables
...
Lists out the data that will show up when you click on a reach
